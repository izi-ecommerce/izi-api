...
class ProductAttributeValueSerializer(IZIModelSerializer):
    ...
    class Meta:
        ...
        fields = overridable(
            'IZIAPI_PRODUCT_ATTRIBUTE_VALUE_FIELDS',
...
class ProductAttributeSerializer(IZIModelSerializer):
    ...
    class Meta:
        ...
        fields = overridable(
            'IZIAPI_PRODUCT_ATTRIBUTE_FIELDS',
...
class ChildProductserializer(BaseProductSerializer):
    ...
    class Meta(BaseProductSerializer.Meta):
        fields = overridable(
            'IZIAPI_CHILDPRODUCTDETAIL_FIELDS',
            default=(
                'url', 'upc', 'id', 'title', 'structure',
                # 'parent', 'description', 'images', are not included by default, but
                # easily enabled by overriding IZIAPI_CHILDPRODUCTDETAIL_FIELDS
