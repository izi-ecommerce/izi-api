...
class BasketSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Basket
        fields = overridable('IZIAPI_BASKET_FIELDS', default=(
    ...
    def get_validation_exclusions(self, instance=None):
        """
        This is needed because izi declared the owner field as ``null=True``,
...
class BasketLineSerializer(IZIHyperlinkedModelSerializer):
    ...
    class Meta:
        model = Line
        fields = overridable('IZIAPI_BASKETLINE_FIELDS', default=(
...
class VoucherAddSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        # izi expects this always to be uppercase.
