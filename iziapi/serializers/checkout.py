...
class PriceSerializer(serializers.Serializer):
    currency = serializers.CharField(
        max_length=12, default=settings.IZI_DEFAULT_CURRENCY, required=False)
...
class OrderLineSerializer(OscarHyperlinkedModelSerializer):
    ...
    class Meta:
        model = OrderLine
        fields = overridable('IZI_ORDERLINE_FIELD', default=[
...
class OrderSerializer(OscarHyperlinkedModelSerializer):
    ...
    class Meta:
        model = Order
        fields = overridable('IZIAPI_ORDER_FIELD', default=(
...
class CheckoutSerializer(serializers.Serializer, OrderPlacementMixin):
    ...
    def get_initial_order_status(self, basket):
        return overridable('IZIAPI_INITIAL_ORDER_STATUS', default='new')
...
class UserAddressSerializer(OscarModelSerializer):
    ...
    class Meta:
        model = UserAddress
        fields = overridable('IZIAPI_USERADDRESS_FIELDS', (
