...
from iziapi import serializers
from iziapi.utils import login_and_upgrade_session
...
class LoginView(APIView):
    ...
    If more details are needed, use the ``IZIAPI_USER_FIELDS`` setting to change
