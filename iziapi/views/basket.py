...
from izi.apps.basket import signals
...
from iziapi import serializers, permissions
from iziapi.basket import operations
from iziapi.views.mixin import PutIsPatchMixin
from iziapi.views.utils import BasketPermissionMixin
...
class AddProductView(APIView):
    ...
    POST(url, quantity)
    {
        "url": "http://testserver.org/iziapi/products/209/",
        "quantity": 6
    }
    ...
    basket, you should pass the optional ``options`` property:
    {
        ...
        "quantity": 6,
        "options": [{
            "option": "http://testserver.org/iziapi/options/1/",
            "value": "some value"
        }]
    }
    """
...
class LineList(BasketPermissionMixin, generics.ListCreateAPIView):
    ...
    Add a line to the basket, example::
        ...
        {
            "basket": "http://127.0.0.1:8000/iziapi/baskets/100/",
            "line_reference": "234_345",
            "product": "http://127.0.0.1:8000/iziapi/products/209/",
            "stockrecord":
                "http://127.0.0.1:8000/iziapi/stockrecords/100/",
            "quantity": 3,
            "price_currency": "EUR",
