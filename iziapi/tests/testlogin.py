...
from iziapi.tests.utils import APITest
from iziapi.utils import get_session, session_id_from_parsed_session_uri
...
class LoginTest(APITest):
    ...
    def test_login_with_header(self):
        ...
        with self.settings(DEBUG=True, IZIAPI_USER_FIELDS=('username', 'id')):
        ...
        with self.settings(IZIAPI_BLOCK_ADMIN_API_ACCESS=False, DEBUG=True, IZIAPI_USER_FIELDS=('username', 'id')):
