...
from iziapi.serializers.product import ProductLinkSerializer
...
class ProductTest(APITest):
    ...
    @mock.patch('iziapi.views.product.ProductList.get_serializer_class')
    ...
    def test_product_attributes(self):
        "All izi attribute types should be supported except entity"
