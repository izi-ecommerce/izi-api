...
Basket Middleware
=================
This is a replacement middleware for ``izi.apps.basket.middleware.BasketMiddleware`` With this middleware, you can mix the API and
regular izi views (also for anonymous users).

 .. autoclass:: iziapi.middleware.ApiBasketMiddleWare
...
.. autoclass:: iziapi.middleware.ApiGatewayMiddleWare
...
See also:
 .. autoclass:: iziapi.models.ApiKey
